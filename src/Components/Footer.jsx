...
const Info = [
  ...
  { id: 2, icon: CustomerSp, info: "Support@projectpackers.com" },
  {
    id: 3,
    icon: Location,
    info: "2118 Thornridge Cir. Syracuse, Connecticut 35624",
  },
];
const Navigate = [
  { id: 1, info: "Home" },
...
export default function Footer() {
  return (
    <div className="bg-header pt-12 p-10 ">
      <div className="ml-auto mr-auto container grid grid-cols-12 gap-x-11 border-b border-white border-opacity-10 pb-12 ">
        ...
        <div className="col-span-3 space-y-8">
          <p className="text-[#6BCCCB] font-semibold text-lg">
            Quick Navigation
          </p>
          <div className="space-y-5">
            {Navigate.map((data) => (
        ...
        <div className="col-span-3 space-y-8">
          ...
          <div className="grid grid-cols-4 gap-2">
            {Payments.map((data) => (
              <div key={data.id}>
                <Image src={data.image} className="w-full h-auto" />
              </div>
            ))}
          </div>
        </div>
      </div>
      <p className="font-normal text-base text-white opacity-70 ml-auto mr-auto container py-4">
